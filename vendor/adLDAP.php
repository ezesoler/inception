...
/*
	...
	********************************************************************
	Modificada por Ezequiel Soler 
	ezequiel@pentamedia.com.ar

	SE MODIFICA CONSTRUCTOR PARA QUE RECIBA PARAMETROS DE CONEXIÓN:
...
class adLDAP {
	...
	// default constructor
	function adLDAP($account_suffix,$base_dn,$domain_controllers){
		$this->_account_suffix = $account_suffix;
		$this->_base_dn = $base_dn;
		$this->_domain_controllers = $domain_controllers;
